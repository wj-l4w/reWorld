...
public class reWorldLobby : NetworkBehaviour
{
    [Header("UI")]
    ...
    {
        CmdSetDisplayerName(PlayerNameInput.DisplayName);
    ...
    public void UpdateDisplay()
    {
        ...
        for (int i = 0; i < Room.RoomPlayers.Count; i++)
        {
            ...
            playerReadyTexts[i].text = Room.RoomPlayers[i].IsReady ? "<color=green>Ready</color>" 
    ...
    [Command]
    private void CmdSetDisplayerName(string displayName)
    {
