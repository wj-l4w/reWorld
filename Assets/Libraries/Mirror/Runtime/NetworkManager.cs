...
namespace Mirror
{
    ...
    /*      NetworkServer.RegisterHandler<ConnectMessage>(OnServerConnectInternal, false);
            ...
            NetworkServer.ReplaceHandler<ConnectMessage>(OnServerConnectInternal, false);
            NetworkServer.ReplaceHandler<DisconnectMessage>(OnServerDisconnectInternal, false);
            NetworkServer.ReplaceHandler<AddPlayerMessage>(OnServerAddPlayerInternal);
            NetworkServer.ReplaceHandler<ErrorMessage>(OnServerErrorInternal, false);
